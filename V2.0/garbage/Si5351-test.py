...
class Si5351(object):
    ...
    def setupPLL(self, pll, mult, num=0, denom=1):
        ...
        # Reset both PLLs
        #print "reset pll"+" "+str(mult)+" "+str(num)+" "+str(denom)
...
if __name__ == '__main__':
    ...
    #si.setupPLL(si.PLL_A, 24, 7, 9)
    # out = 616.67 MHz / 45 = 13.703704 MHz 
    
    #si.setupPLL(si.PLL_A, 25, 2, 10)
    #si.setupMultisynth(0, si.PLL_A, 30)
    
    
    si.setupPLL(si.PLL_A, 25, 2, 10)
    si.setupMultisynth(0, si.PLL_A, 70)
    
    #si.setupPLL(si.PLL_B, 25, 2, 10)
    #si.setupMultisynth(2, si.PLL_B, 70)    
